...
This repo contains my personal Equicord setup script. It installs Equicord and lets me manage a small collection of custom plugins that I personally use.
...
Evidence published by Vendicated:
https://gist.github.com/Vendicated/bb30cb67878fa682bcee140f56af1531
...
Download or clone the repo, then run `Equicord.bat` normally and follow the menu.

Do not run it as Administrator. The script intentionally refuses to continue when elevated.
